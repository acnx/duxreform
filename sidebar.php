...
<?php endif; ?>
<?php if (!empty($this->options->sidebarBlock) && in_array('ShowRecentPosts', $this->options->sidebarBlock)): ?>
    <div class="widget widget-tops" style="background:url(https://cseve.com/usr/themes/daqd/img/1.jpg)">
...
<?php endif; ?>
<div class="widget widget_ui_tags" style="top: 0px;">
        <h3>友链</h3>
        <div class="items">
            <a href="https://cseve.com">江湖寻梦博客</a>
            <a href="https://cseve.com">友情链接二</a>
            <a href="https://cseve.com">友情链接三</a>
            <a href="https://cseve.com">友情链接四</a>
            <a href="https://cseve.com">友情链接五</a>
            <a href="https://cseve.com">友情链接六</a>
        </div>
    </div>
    </aside>
    <!-- end sidebar -->
