...
<?php endif; ?>
            <div class="copyright">
                <p>
                    &copy; 2019 - <?php echo date("Y"); ?> <a href="<?php $this->options ->siteUrl(); ?>"><?php $this->options->title();?></a>
                   ...
                   <a href="https://tongji.baidu.com/web/welcome/ico?s=c86d0c59b88704d5391cdf27d29a37fb" target="_blank">本</a>站部分图片、文章来源于网络，版权归原作者所有，如有侵权，请联系我们删除。
                </p>
            </div>
            <div class="hide"></div>
        </div>
